...
save(cds,genes, file = file.path(projectPath, "Data/Integration20250829","objIntegrated_Monocle3_cds.genes.Rdata"))

load(file.path(projectPath, "Data/Integration20250829","objIntegrated_Monocle3_cds.Rdata"))
...
pdf(file.path(projectPath, "Output/Integration20250829","objIntegrated_Monocle3_Result02_TopOrderedGenes.pdf"), height = 10, width = 10)
